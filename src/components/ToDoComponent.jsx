...
function ToDoList({ userId, setPageTab }) {
    ...
    return (
        <div className="to-do-app">
            <button className="logout" onClick={() => setPageTab("welcome")}>log-out</button>
            <br />
                            ...
                            <div className="items" key={index}>
                                <div className="flex">
                                    ...
                                    <div style={{ minWidth: '150px' }}>
                                        <button className="edit" onClick={() => handleEditItems(index)}><i className="fa-solid fa-pen-to-square"></i></button>
                                        <button className="delete" onClick={() => handleDeleteItems(index)}><i className="fa-solid fa-trash "></i></button>
                                    </div>
                                </div>
                            </div>
                        );
